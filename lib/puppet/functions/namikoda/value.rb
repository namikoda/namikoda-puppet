...
Puppet::Functions.create_function(:'namikoda::value') do
  def value(key)
    ...
    begin
      if @@namikoda_apikey.to_s.empty?
        raise "namikoda::value missing namikoda_apikey. Be sure to call namikoda::set_apikey() before this function."
      end
    rescue NameError => e
        raise "namikoda::value missing namikoda_apikey. Be sure to call namikoda::set_apikey() before this function."
    end
